...
webdamlog compliante trace graphs. You should run a wl instance with
options :trace to true then you can execute wlbudvis on the directory
created under bin usually called DBM_*
