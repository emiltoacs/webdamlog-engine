...
module WLBud
  ...
  #file project
  require "wlbud/wlprogram"
  require "wlbud/wlpacket"
  require "wlbud/wlerror"
  require "wlbud/wlchannel"
  require "wlbud/wlvocabulary"
  # file project: automatically generated by polyglot but could also be compiled
  # via tt
  require "wlbud/wlgrammar"
  #file tool project
  require "wlbud/tools/wltools"
