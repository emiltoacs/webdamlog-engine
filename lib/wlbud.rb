...
module WLBud
  ...
  WLBUD_DIR_PATH = File.expand_path(File.dirname(__FILE__))
  PROJECT_PATH = File.join(WLBUD_DIR_PATH,"..")
  LIB = "wlbud/"
  CONFIG = "config/"
  ...
  #gems
  require 'rubygems'
  gem 'bud', "= #{Config::BUD_GEM_VERSION}"
  require 'bud'
  require 'polyglot'
  require 'treetop'
  require 'yaml'
  ...
  #file tool project
  require "#{LIB}tools/wltools"
  #file project
  require "#{LIB}wlprogram"
  require "#{LIB}wlpacket"
  require "#{LIB}wlerror"
  require "#{LIB}wlchannel"
  require "#{LIB}wlvocabulary"
  #require "#{PROJECT_PATH}/fr/inria/webdam/webdamlog/wlbud/storage/dbm.rb"
  # file project: automatically generated by polyglot but could also be compiled
  # via tt
  require "#{LIB}wlgrammar"
